...
public class QosWorker {
    ...
    public static void main(String[] args) throws IOException, TimeoutException {
        ...
        channel.queueDeclare(QosNewTask.TASK_QUEUE_NAME, durable, false, false, null);
        /* 设置获取数量参数，通过设置该参数，RabbitMQ在收到消息处理成功反馈前，
        都不会向消费者发送新的消息，保证消息分发的公平性 */
        channel.basicQos(1);
        // 创建消费者，阻塞接收消息
...
//        boolean autoAck = true; // acknowledgment is covered below
        ...
        channel.basicConsume(QosNewTask.TASK_QUEUE_NAME, autoAck, consumer);
    }
